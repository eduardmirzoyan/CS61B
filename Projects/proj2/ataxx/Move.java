...
class Move {
    ...
    private Move(int col0, int row0, int col1, int row1) {
        ...
        _isExtend = Math.abs((int) _col0  - (int) _col1) == 1
                || Math.abs((int) _row0  - (int) _row1) == 1;
        _isJump = Math.abs((int) _col0  - (int) _col1) == 2
                || Math.abs((int) _row0  - (int) _row1) == 2;
    }
    ...
    /** Return the linearlinearized index of my 'from' square,
     *  or -1 if I am a pass. */
    int fromIndex() {
        return _fromIndex;
    }
    ...
    public String toString() {
        if (_col0 == 0 && _col1 == 0 && _row0 == 0 && _row1 == 0) {
            return "-";
        }
